...
<div id="wrapper">
    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($query_run)>0){
            ...
            $query_run=mysqli_query($con,$query);
            if(mysqli_num_rows($query_run)>0){
                $query = "DELETE FROM bus WHERE route_no='$route_no' and bus_no='$bus_no'";
                $query_run = mysqli_query($con,$query);
                ...
                echo '<script type="text/javascript"> alert("the rout no. does not exist ,please go to edit page ")</script> ';


            }
        }else{
            echo '<script type="text/javascript"> alert("the bus no. does not exist ,please go to edit page ")</script> ';
